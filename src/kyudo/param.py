...
CompleteAction_params = [
   ...
   {'frame': '1.7-m',  # 約0.5秒
     ...
     'param': [
        [None, None, None, None, None, None, None, None],            # 0.
        [0.180, 0.9, 0.015, 0.015, 0.015, 0.015, 1.000, 9],          # 1.足踏み
        [50.0, 90.0, 120.0, 0.012, 2, 0.040, 2, 5, 0.03],            # 2.胴作り
...
#
Diduct_params = {
    's6_split_tm': ((2.5, 5),   '会の時間が短い'),         # 会の時間がこの値未満の場合に減点する
    's8_split_tm': ((1.5, 5),   '残身の時間が短い'),       # 残身の時間がこの値未満の場合に減点する
    's8_sl_angle': ((5.0, 10),  '弓手の下がりが大きい')    # 弓手の下がりがこの値を超える場合に減点する
}
# eof

...
CompleteAction_params = [
    ...
    {'flame': '8n',  # 約0.5秒
     'param': [
        ...
        [50.0, 95.0, 0.015, 2, 0.080, 5, None, None],           # 2.胴作り
   ...
   {'flame': '8s',  # 約0.5秒
     'param': [
        [None, None, None, None, None, None, None, None],       # 0.
        [0.028, 0.5, 0.015, 0.015, 0.015, 0.015, 0.015, 3],     # 1.足踏み
        [50.0, 90.0, 0.015, 2, 0.080, 5, None, None],           # 2.胴作り
        [0.015, 0.015, 0.015, 0.015, 5, 0.027, 2, 0.04 ],       # 3.弓構え
        [0.015, 0.015, 0.015, 0.015, 8, None, None, None],      # 4.打起こし
        [0.010, 1.000, 0.010, 1.000, 5, 0, 0.085, None],        # 5.引分け
        [0.010, 0.010, 0.010, 0.010, 5, 0.050, 0.00, None],     # 6.会
        [5, None, None, None, None, None, None, None],          # 7.離れ

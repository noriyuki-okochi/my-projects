...
CompleteAction_params = [
    {'frame': '18-n',   #約1.0秒
     ...
     'param': [
        ...
        [0.025, 1.000, 0.025, 1.000, 5, 0, 0.085, 0.008, 8],        # 5.引分け
    ...
    {'frame': '8-n',  # 約0.5秒
     ...
     'param': [
        ...
        [0.015, 1.000, 0.015, 1.000, 5, 0, 0.085, 0.008, 8],        # 5.引分け
   ...
   {'frame': '8-s',  # 約0.5秒
     ...
     'param': [
        ...
        [0.008, 1.000, 0.008, 1.000, 5, 0, 0.085, 0.008, 8],        # 5.引分け
   ...
   {'frame': '1.7-s',  # 約0.5秒
     ...
     'param': [
        ...
        [50.0, 90.0, 0.015, 2, 0.040, 5, None, None],           # 2.胴作り
        [0.015, 0.015, 0.015, 0.015, 5, 0.027, 2, 0.04 ],       # 3.弓構え
        [0.005, 0.005, 0.005, 0.005, 8, None, None, None],      # 4.打起こし
        [0.008, 1.000, 0.008, 1.000, 5, 0, 0.085, 0.008, 8, 0.02],    # 5.引分け
        [0.008, 0.008, 0.008, 0.008, 5, 0.050, 0.00, None],     # 6.会
        [5, None, None, None, None, None, None, None],          # 7.離れ
        [0.080, 0.080, 3, None, None, None, None, None],        # 8.残心
        [25.0, 95.0, 0.030, 5, 0.085, None, None, None],        # 9.弓倒し
